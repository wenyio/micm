	...
	export default{
		props:{
			...
			bgColor:{
				//按钮背景颜色
				type: String,
				default: "linear-gradient(to right, rgba(98,221,255,0.2), rgba(98,221,255,0.8))",
			},
			fontColor:{
				//按钮字体颜色
				type: String,
...
<style>
	...
	.dlbutton {
		...
		width:601upx;
		height:100upx;
		background:linear-gradient(to right, rgba(98,221,255,0.7), rgba(98,221,255,0.6));
	...
	.buttonBorder{
	    border: none ;
	    border-radius: 2.5rem ;
	    -webkit-box-shadow: 0 0 60upx 0 rgba(98,221,255,.2) ;
	    box-shadow: 0 0 60upx 0 rgba(98,221,255,.2) ;
