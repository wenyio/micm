 ...
 */
@Entity
@Table(name = "service_practice_organization")
public class ServicePracticeOrganization implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        ServicePracticeOrganization that = (ServicePracticeOrganization) o;
        return id == that.id &&
